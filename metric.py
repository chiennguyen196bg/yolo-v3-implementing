...
def _box_iou(box1, box2):
    """
    calculate iou
    :param box1: tensor, shape=[..., 4], dimension: N
    :param box2: tensor, shape=[..., 4], dimension: K
    :return: iou: tensor, has dimension: (N-1) + (K-1)
    """
...
def _process_predict_an_image(predict, ground_truth, num_classes, iou_threshold):
    ...
    for c in range(num_classes):
        ...
        iou = _box_iou(class_predict_boxes, class_ground_truth_boxes)
